    ...
    useEffect(() => {
        ...
        class CommonClass {
            ...
            init(container: HTMLElement) {
                ...
                this.pixelRatio = Math.min(window.devicePixelRatio || 1, 1.5); // Cap at 1.5
                this.resize();
                this.renderer = new THREE.WebGLRenderer({ antialias: false, alpha: true }); // Disable antialias for perf
...
`;
        ...
        class Output {
            ...
            constructor() {
                this.simulation = new Simulation({}); // Initialize with default options
                this.scene = new THREE.Scene();
                this.camera = new THREE.Camera();
